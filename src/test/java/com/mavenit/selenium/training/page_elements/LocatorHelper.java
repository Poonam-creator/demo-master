...
public class LocatorHelper extends Hooks {
    ...
    public void clickSearch() {
        ...
        // xpath for button=//*[@id="searchForm"]/fieldset/div[2]/div/button/span
    }
    ...
    public void selectPrice(String priceRange) {
       ...
       // List<WebElement>filters = driver.findElements(By.cssSelector("//div[@id='product-actions']//button[@class='Button-hYXUXp fIBPaH'][contains(text(),'Add to basket')]"));
